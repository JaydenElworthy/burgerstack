  ...
  return (
    <div className="h-screen w-full flex flex-col overflow-hidden select-none font-sans bg-[#E55937] relative text-[#FFE974]">
      ...
      <div className="flex-1 relative flex flex-col items-center justify-end overflow-hidden">
        ...
        {/* This container anchors everything to the counter */}
        <div className="relative w-full flex flex-col items-center justify-end">
          ...
          {/* Counter Image: Sits at the absolute bottom of this container */}
      ...
      <div className="p-6 grid grid-cols-3 gap-4 bg-[#FFE974] border-t-8 border-black pb-12 z-50 shadow-2xl">
        <button onPointerDown={(e) => { e.preventDefault(); handleInput('patty'); }} className="bg-[#4B2C20] text-white border-4 border-black py-8 rounded-2xl font-bold text-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-y-1 active:shadow-none">PATTY</button>
        <button onPointerDown={(e) => { e.preventDefault(); handleInput('cheese'); }} className="bg-[#FFD700] text-black border-4 border-black py-8 rounded-2xl font-bold text-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-y-1 active:shadow-none">CHEESE</button>
        <button onPointerDown={(e) => { e.preventDefault(); handleInput('bun'); }} className="bg-white text-[#E55937] border-4 border-black py-8 rounded-2xl font-bold text-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-y-1 active:shadow-none">BUN</button>
      </div>
        ...
        <div className="absolute inset-0 bg-black/95 z-[100] flex flex-col items-center justify-center p-10 text-center">
          <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="w-full max-w-sm">
            ...
            <div className="mb-10 text-[#FFE974]">
              <p className="text-white/60 font-bold uppercase text-xs mb-1 tracking-widest italic text-center w-full font-sans">Total Burgers</p>
